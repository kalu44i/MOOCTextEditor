...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			double basicTime = (double)(endBasicTime - startBasicTime)/1000000000;
			System.out.print(basicTime + "\t");
			long startEffTime = System.nanoTime();

			for (int i = 0; i < trials; i++) {
				Document doc1 = new EfficientDocument(text);
				doc1.getFleschScore();
			}
			long endEffTime = System.nanoTime();
			double effTime = (double)(endEffTime - startEffTime)/1000000000;
			System.out.println(effTime);
