...
public class BasicDocument extends Document 
{
	...
	public int getNumSentences()
	{
	    //TODO: Implement this method.  See the Module 1 support videos 
        // if you need help.
		String[] sentenses = getText().split("\\?+|\\.+|!+");
		int result = 0;
	...
	public int getNumSyllables()
	{
		...
		for (String word : words) {
			result = result + countSyllables(word);
		}
	...
	public double getFleschScore() {
		{
			...
			int sen = getNumSentences();
			int syll = getNumSyllables();

			return 206.835 - 1.015 * (double)words/sen - 84.6 * (double)syll/words;
		}
	}
	...
	public static void main(String[] args)
	{
		...
		testFlashCase(new BasicDocument("Sentence"), 36.6);
